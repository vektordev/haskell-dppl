...
Usage (from the repository root):
    ...
    stack run -- -i test/cases/neural/mNistAdd.ppl compile -l python -o /tmp/mnist_scalar.py
    stack run -- -i test/cases/neural/mNistAdd.ppl compile -l python -o /tmp/mnist_batched.py --batched
