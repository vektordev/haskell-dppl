...
generateCode (IRLeft x) = wrap "(false, " (generateCode x) ", nothing)"
generateCode (IRRight x) = wrap "(true, nothing, " (generateCode x) ")"
generateCode (IRFromLeft x) = wrap "(" (generateCode x) ")[2]"
generateCode (IRFromRight x) = wrap "(" (generateCode x) ")[3]"
generateCode (IRIsLeft x) = wrap "!(" (generateCode x) ")[1]"
generateCode (IRIsRight x) = wrap "(" (generateCode x) ")[1]"
...
generateCode (IRInvoke expr) = generateCode expr
