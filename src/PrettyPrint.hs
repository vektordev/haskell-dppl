...
pPrintIRExpr (IRLogDensity dist e) n = "logDensity " ++ show dist ++ " (" ++ pPrintIRExpr e (n + 1) ++ ")"
pPrintIRExpr (IRLogCumulative dist e) n = "logCumulative " ++ show dist ++ " (" ++ pPrintIRExpr e (n + 1) ++ ")"
